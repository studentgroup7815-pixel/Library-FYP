...
const Books = () => {
    ...
    try {
        ...
        const { data } = await axios.post(
            `${import.meta.env.VITE_API_URL}/books/generate-ai-description`,
            {
        ...
        console.error(error);
        alert('Failed to generate description. Check API Key or try again.');
    } finally {
        setGenerating(false);
    }
};
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-400 mb-2">
                                ...
                                <button
                                    ...
                                    disabled={generating || !formData.title || !formData.author}
                                    className="ml-2 text-xs bg-purple-600/20 text-purple-400 px-2 py-1 rounded hover:bg-purple-600/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
